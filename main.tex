...
\usepackage[num,abnt-etal-list=0]{./abntex2cite} % Citações numéricas (ordem de apresentação)
%\usepackage[alf,abnt-etal-list=0]{./abntex2cite} % Citações autor-data (ordem alfabética)
...
\programapgdepartamento{Engenharia de Transportes} % departamento: apenas para a PG, comentar para PFC
...
\coorientador{Beltrano}{Silva}{D.Sc.} % se não tiver, use \coorientador{}{}{}
% ---
